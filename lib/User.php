...
class User{
  private $db;
	...
	public function userRegistration($data){
        ...
        if ($chk_email == true) {
         ...
         if ($result) {
        	$msg = "<div class='alert alert-success'> <strong>Seccess ! </strong>Thanks for your Registration!</div>";
        	return $msg;
         }else{
        	$msg = "<div class='alert alert-danger'> <strong>Sorry ! </strong>There is a problem to insert your data!</div>";
        	return $msg;
         }
	}
  ...
  public function updateUserData($id , $data){
        ...
        if ($name == "" OR $username == "" OR $email == "") {
         ...
         $result = $query->execute();
         if ($result) {
          $msg = "<div class='alert alert-success'> <strong>Seccess ! </strong>User data updated successfully!</div>";
          return $msg;
         }else{
          $msg = "<div class='alert alert-danger'> <strong>Sorry ! </strong>There is a problem to update your data!</div>";
          return $msg;
         }
  ...
  public function updatePassword($id , $data){
    ...
    $sql = "UPDATE tbl_user set
         ...
         $result = $query->execute();
         if ($result) {
          $msg = "<div class='alert alert-success'> <strong>Seccess ! </strong>User's Password  updated successfully!</div>";
          return $msg;
         }else{
          $msg = "<div class='alert alert-danger'> <strong>Sorry ! </strong>There is a problem to update your password!</div>";
          return $msg;
         }
